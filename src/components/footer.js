...
export default function Footer(){
    return(
      <nav className="navbar navbar-expand-lg navbar-light justify-content-center" style={{display:'flex', justifyContent:'bottom', left:0, right:0, bottom:0, marginTop:'1%'}}>    
    <div className="m-2">
